...
In dieser Datenschutzerklärung wird beschrieben, wie Ihre personenbezogenen Daten erfasst, verwendet und weitergegeben werden, wenn Sie Kopfsache by Stephan (die "Website") nutzen oder dort etwas kaufen.
</p>
<h4>VON UNS ERFASSTE PERSONENBEZOGENE DATEN</h4>
<p>
...
Wir erfassen Geräteinformationen mithilfe der folgenden Technologien:
    ...
    - "Cookies" sind Datendateien, die auf einem Gerät oder Computer gespeichert werden und häufig eine anonyme eindeutige Kennung enthalten. Weitere Informationen zu Cookies und zum Deaktivieren von Cookies sind unter http://www.allaboutcookies.org zu finden.<br/>
    - "Protokolldateien" protokollieren Aktionen auf der Website und erfassen Daten wie IP-Adresse, Browsertyp, Internetdienstanbieter, verweisende/Ausstiegsseiten sowie Datums-/Uhrzeitstempel.<br/>
    - "Web Beacons", "Tags" und "Pixel" sind elektronische Dateien zur Erfassung von Informationen dazu, wie Sie auf der Website navigieren.<br/>

<br/>
</p>
<p>
Wenn Sie auf der Website etwas kaufen oder versuchen, etwas zu kaufen, erfassen wir außerdem bestimmte Informationen über Ihre Person. Dazu gehören Name, Rechnungsadresse, Lieferadresse, Zahlungsinformationen (einschließlich Kreditkartennummern [[ANDERE ZULÄSSIGE ZAHLUNGSARTEN EINFÜGEN]]), E-Mail-Adresse und Telefonnummer.  Wir bezeichnen diese Angaben als "Bestellinformationen".
...
KONTAKT
Wenn Sie weitere Informationen zu unseren Datenschutzverfahren benötigen, Fragen haben oder eine Beschwerde einreichen möchten, kontaktieren Sie uns per E-Mail an falko.puchalla@gmail.com oder per Post an die unten genannte Adresse:

  Esslingerstraße 10, Unterensingen, 72669, Deutschland
    </p>
</section>
<Footer />
