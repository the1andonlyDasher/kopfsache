...
import Sec from "../components copy/Section"
...
const Impressum = () => {
    ...
    return (<>
        <section className="my-12">
            ...
            <h3>Übersicht</h3>
            <p>
                Diese Website wird von Kopfsache by Stephan betrieben. Überall auf der Webseite beziehen sich die Begriffe "wir", "uns" und "unsere/e" auf Kopfsache by Stephan. Kopfsache by Stephan bietet diese Website, einschließlich aller Informationen, Tools und Dienste, die auf dieser Website verfügbar sind, Ihnen, dem Benutzer, unter der Bedingung an, dass Sie alle hier angegebenen Bedingungen, Konditionen, Richtlinien und Hinweise akzeptieren.
            ...
            <h4>1 - BEDINGUNGEN FÜR DEN ONLINESHOP</h4>
            <p>
            ...
            </p><h4>2 - ALLGEMEINE BEDINGUNGEN</h4>
            <p>
            ...
            </p><h4>3 - GENAUIGKEIT, VOLLSTÄNDIGKEIT UND RECHTZEITIGKEIT DER INFORMATIONEN</h4>
            <p>
            ...
            </p><h4>4 - ÄNDERUNGEN AN DER LEISTUNG UND DEN PREISEN</h4>
            <p>
            ...
            </p><h4>5 - PRODUKTE ODER SERVICELEISTUNGEN</h4>
            <p>
            ...
            </p><h4>9 - BENUTZERKOMMENTARE, FEEDBACK UND ANDERE EINSENDUNGEN</h4>
            <p>
            ...
            </p><h4>10 - PERSONENBEZOGENE DATEN</h4>
            <p>
            ...
            </p><h4>11 - FEHLER, UNGENAUIGKEITEN UND AUSLASSUNGEN</h4>
            <p>
            ...
            </p><h4>12 - VERBOTENE ANWENDUNGEN</h4>
            <p>
                ...
                (g) um Viren oder jede andere Art von schädlichem Code hochzuladen oder zu übertragen, die auf irgendeine Weise die Funktionalität oder den Betrieb der Serviceleistung oder irgendeiner zugehörigen Website, anderer Websites oder des Internets beeinträchtigen; (h) um persönliche Daten anderer zu sammeln oder zu verfolgen; (i) zum Spammen, Phishing, Pharming, Pretexting, Spidering,

                Crawling oder Scraping; (j) für irgendwelche obszönen oder unmoralischen Zwecke; oder (k) um die Sicherheitsfunktionen der Serviceleistung oder irgendeiner zugehörigen Website, anderer Websites oder des Internets zu stören oder zu umgehen. Wir behalten uns das Recht vor, Ihre Nutzung der Serviceleistung oder irgendeiner zugehörigen Website zu beenden, wenn Sie eine der verbotenen Anwendungen missachten.
            </p><h4>13 - HAFTUNGSAUSSCHLUSS; HAFTUNGSBESCHRÄNKUNG</h4>
            <p>
            ...
            <h4>18 - GELTENDES RECHT</h4>
            <p>

                Diese Allgemeinen Geschäftsbedingungen und alle separaten Vereinbarungen, in deren Rahmen wir Ihnen Serviceleistungen zur Verfügung stellen, unterliegen den Gesetzen von Esslingerstraße 10, Unterensingen, 72669 , Deutschland und sind nach diesen auszulegen.


            </p>
            <h4>19 – ÄNDERUNGEN DER ALLGEMEINEN GESCHÄFTSBEDINGUNGEN</h4>
            <p>
            ...
            <h4>20 – KONTAKTDATEN</h4>
            <p>

                Fragen zu den Allgemeinen Geschäftsbedingungen sind unter stephan.muller4@aol.de an uns zu richten.
